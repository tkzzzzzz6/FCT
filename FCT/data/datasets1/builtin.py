...
def register_all_pascal_voc(root="datasets"):
    ...
    METASPLITS = [
        ...
        ("disease_trainval_base1", "Disease", "trainval", "base1", 1),
        #("voc_2007_trainval_base2", "VOC2007", "trainval", "base2", 2),
        ("disease_trainval_base2", "Disease", "trainval", "base2", 2),
        #("voc_2007_trainval_base3", "VOC2007", "trainval", "base3", 3),
        ("disease_trainval_base3", "Disease", "trainval", "base3", 3),
        ...
        ("disease_trainval_all1", "Disease", "trainval", "base_novel_1", 1),
        ("disease_trainval_all2", "Disease", "trainval", "base_novel_2", 2),
        ("disease_trainval_all3", "Disease", "trainval", "base_novel_3", 3),
        ...
        ("disease_test_base1", "Disease", "test", "base1", 1),
        ("disease_test_base2", "Disease", "test", "base2", 2),
        ("disease_test_base3", "Disease", "test", "base3", 3),
        ("disease_test_novel1", "Disease", "test", "novel1", 1),
        ("disease_test_novel2", "Disease", "test", "novel2", 2),
        ("disease_test_novel3", "Disease", "test", "novel3", 3),
        ("disease_test_all1", "Disease", "test", "base_novel_1", 1),
        ("disease_test_all2", "Disease", "test", "base_novel_2", 2),
        ("disease_test_all3", "Disease", "test", "base_novel_3", 3),
        ...
        for sid in range(1, 4):
            for shot in [1, 2, 3, 5, 10]:
                for seed in range(100):
                    ...
                    name = f"disease_trainval_{prefix}{sid}_{shot}shot_{seed}_{unique_id}"
                    dirname = "Disease"
